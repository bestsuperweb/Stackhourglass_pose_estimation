...
class BaseModel(Model):
    ...
    def __init__(self, opts):
        ...
        # print ('=============== p4.get_shape()', p4.get_shape()) # (2, 7, 7, 512)
        reshape = tf.reshape(p4, [B, -1])
        # print ('=============== reshape.get_shape()', reshape.get_shape()) # (2, 25088)
        ...
        # print ('=============== self.y.get_shape()', self.y.get_shape()) # (2, 16, 2)
...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        print ("np.array(pred).shape => ", np.array(pred).shape)
